...
//if($_SERVER["REQUEST_METHOD"] === "GET"){
    try{ 
        $stmt = $conn->prepare("SELECT * FROM `insert_car` where id =?");
        $id= $_GET["id"];
        $stmt->execute([$id]);
        $result = $stmt->fetch();
    }
...
<body>
    ...
    <div class="container-fluid pt-5">
        <div class="container pt-5 pb-3">
            <h1 class="display-4 text-uppercase mb-5"><?php echo $result["car_title"];?></h1>
            <div class="row align-items-center pb-2">
                <div class="col-lg-6 mb-4">
                    <img class="img-fluid" src="img/<?php echo $result["car_image"];?>" alt="<?php echo $result["car_title"];?>">
                </div>
                <div class="col-lg-6 mb-4">
                    <h4 class="mb-2">$<?php echo $result["car_price"];?>/Day</h4>
                    ...
                    <p><?php echo $result["car_content"];?></p>
            ...
            <div class="row mt-n3 mt-lg-0 pb-4">
                <div class="col-md-3 col-6 mb-2">
                    ...
                    <span>Model: <?php echo $result["car_model"];?></span>
                </div>
                <div class="col-md-3 col-6 mb-2">
                    <i class="fa fa-cogs text-primary mr-2"></i>
                    <span><?php echo $result["transmission_type"];?></span>
                </div>
                <div class="col-md-3 col-6 mb-2">
                    <i class="fa fa-road text-primary mr-2"></i>
                    <span><?php echo $result["fuel_consumption"];?>km/liter</span>
                </div>
                <div class="col-md-3 col-6 mb-2">
                    <i class="fa fa-eye text-primary mr-2"></i>
                    <span><?php echo $result["car_properties"];?></span>
                </div>
            <!--
                <div class="col-md-3 col-6 mb-2">
                    <i class="fa fa-car text-primary mr-2"></i>
