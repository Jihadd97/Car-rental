...
try{ 
      ...
      $stmt1 = $conn->prepare("SELECT * FROM `testimonials`");
      $stmt->execute();  
      $stmt1->execute();  
  }
...
<div class="container-fluid py-5">
 ...
 <div class="container-fluid py-5">
        <div class="container py-5">
            ...
            <?php foreach($stmt1->fetchAll() as $k){
                $id=$k["id"];
                $name=$k["client_name"];
                $position=$k["client_position"];
                $content=$k["client_perspective"];
                $image=$k["client_image"];
            ?>
            <div class="owl-carousel testimonial-carousel">
                <div class="testimonial-item d-flex flex-column justify-content-center px-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <img class="img-fluid ml-n4" src="<?php echo $image?>" alt="<?php echo $name?>">
